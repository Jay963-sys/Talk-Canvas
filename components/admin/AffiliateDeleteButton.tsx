...
export default function AffiliateDeleteButton({ id }: { id: number }) {
  ...
  const handleDelete = async () => {
    if (
      !confirm(
        "Delete this code? Past orders keep their discount record for reconciliation, but the code will stop working immediately.",
      )
    ) {
      return;
    }
